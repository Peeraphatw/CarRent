                ...
                <div class="card mb-5 border-dark shadow-lg">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col">
                                <img src="CarStore/<?=$data["Path"]?>" class="shadow-lg rounded img-thumbnail" alt="" />
                            </div>
                            <h5 for="inputEmail3" class="col-12 text-center font-weight-bold p-2">
                        ...
                        <form action="Reservetion.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="inputPassword3" class="col-sm-2 col-form-label">Personnal Number</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="inputPassword5" name="Address" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputPassword3" class="col-sm-2 col-form-label">Tel</label>
                                <div class="col-sm-10">
                                    <input type="tel" class="form-control" id="inputPassword5" name="Tel" />
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="datetime-local" class="form-control" id="TimeRent1" name="Rent_Time" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-2">Return Time</div>
                                <div class="col-sm-10">
                                    <input type="datetime-local" class="form-control" id="TimeRent2"
                                        name="Return_Time" />
                                </div>
                            </div>
                            <div class="form-row">
