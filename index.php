...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div
          class="col-12 d-flex justify-content-between align-items-center p-5 flex-wrap"
        >
        <?php 
          ...
          <div class="card shadow-lg mb-3" style="width: 25rem">
            ...
            <div class="card-body">
              ...
              <?php
                  ...
                  ?> 
              <a href="Reserve.php?CarSequence=<?=$data["CarSequence"]?>"><button class="btn btn-primary">Rent</button></a> 
            </div>
          </div>
          <?php } ?>
      ...
      <div class="row">
        <div
          class="col bg-secondary d-flex align-items-center justify-content-start"
        >
