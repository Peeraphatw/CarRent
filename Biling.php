        ...
        <div class="col">
          <div class="card mt-5">
            ...
            <div class="card-body">
              ...
              ?>
              <div
                class="form-row d-flex justify-content-center align-items-center flex-column"
              >
                <img
                  src="CarStore/<?=$data2['Path']?>"
                  class="img-thumbnail m-5"
                  alt=""
                />
                ...
                <form
                  action="Biling_Upload.php" method="POST"  enctype="multipart/form-data"
