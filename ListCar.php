          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-lg-3">
              <div class="card m-3">
                ...
                <div class="card-body">
                  <img
                    src="CarStore/<?=$row["Path"]?>"
                    class="rounded mb-3 img-thumbnail border-info"
                    alt=""
                  />
                  ...
                  ?>             
                  <a href="Reserve.php?CarSequence=<?=$row["CarSequence"]?>"><button class="btn btn-primary">Rent</button></a>             
                </div>
