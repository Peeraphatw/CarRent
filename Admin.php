              ...
              >
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-monospace"><a href="PersonId/<?=$row["PathPersonnumber"]?>" target="_blank"><button class="btn btn-success">ShowIdCard</button></a></td>
                    
                    <td class="text-monospace"><a href="DriverId/<?=$row["PathDriver"]?>" target="_blank"><button class="btn btn-success">ShowDriverLicense</button></a></td>
                      ...
                      ?>
                    <td class="text-monospace"><a href="CarStore/<?=$data_path["Path"]?>" target="_blank"><button class="btn btn-success">ShowCarPicking</button></a></td>
                            ...
                            <div class="modal-body text-dark">                            
                              <div class="form-row">
                                ...
                                <select name="RentStatus" id="" class="form-control">
                                  <option value="<?=$row["RentStatus"]?>"><?=$row["RentStatus"]?></option>
                                  <?php
                              ...
                              <div class="form-row">
                                ...
                                <input type="datetime-local" class="form-control" id="TimeRent1" name="Actual_Return"
                    />
                              </div>
                            </div>
                            
                            <input type="hidden" name="MID" value="<?=$row["ID"]?>">
                            <input type="hidden" name="CarPicking" value="<?=$row["CarSequence"]?>">
